...
### Changed
 ...
 - upgrade to [@rokucommunity/bslint@0.8.41](https://github.com/rokucommunity/bslint/blob/master/CHANGELOG.md#0841---2026-03-25). Notable changes since 0.8.38:
...
### Removed
 - Remove @only() from async test cases ([#74](https://github.com/rokucommunity/promises/pull/74))
